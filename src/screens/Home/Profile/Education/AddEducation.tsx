...
const AddEducation = ({ props, navigation }: any) => {
    ...
    const onAddEducation = () => {
        ...
        if (instituteName === "") {
            ...
            Toast.show('Please enter institute name', Toast.SHORT);
            return
        }
        if (degree === "") {
            Toast.show('Please enter degree', Toast.SHORT);
            return
        }
        if (fieldOfStudy === "") {
            Toast.show('Please enter field of study', Toast.SHORT);
            return
        }
        if (startDate === "") {
            Toast.show('Please enter start date', Toast.SHORT);
            return
        }
        if (endDate === "") {
            Toast.show('Please enter end date', Toast.SHORT);
            return
        }
                        ...
                        <View style={{ marginVertical: 5 }}>
                            ...
                            >
                                ...
                                <TextInput
                                    ...
                                    returnKeyType='go'
                                    value={instituteName}
                                    onChangeText={(v) => setInstituteName(v)}
